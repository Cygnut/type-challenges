...
// Note that this ignores the case that you have any object keys containing a > 1 dots 
// (which is possible - but pretty silly..). It *does* handle the case that there is
// 1 dot for a property name, but not multiple (e.g. { ['a.b.c']: true })
